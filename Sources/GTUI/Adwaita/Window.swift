...
public class Window: NativePeer {
  ...
  public var isMaximized: Bool {
    gtui_window_is_maximized(self.nativePtr) != 0
  }
  ...
  public func unmaximize() {
    gtui_window_unmaximize(self.nativePtr)
  }

  public func fullscreen() {
    gtui_window_enter_fullscreen(self.nativePtr)
  }

  public func unfullscreen() {
    gtui_window_leave_fullscreen(self.nativePtr)
  }

  public func minimize() {
    gtui_window_minimize(self.nativePtr)
  }
